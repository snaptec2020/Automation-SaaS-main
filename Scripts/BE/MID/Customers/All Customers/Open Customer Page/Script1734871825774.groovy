...
CustomKeywords.'mid.framework.menu.openAllCustomersFormsFromCustomers'()

CustomKeywords.'generalactions.generalActions.waiteSpinnerToHide'()

WebUI.verifyElementPresent(findTestObject('Object Repository/Mid/All Customer/allCustomerTitle'), 5)
