...
def errorMessage = findTestObject('Object Repository/BE/MID/Sign In/Fail login popup').findPropertyValue('xpath') + '/div/span'
...
for (int i = 1; i <= 3; i++) {
    switch (i) {
        case 1:
            ...
            WebUI.callTestCase(findTestCase('BE/MID/General Test Cases/Sign In General Steps'), [('userName') : Keys.chord(
        ...
        case 2:
            ...
            WebUI.callTestCase(findTestCase('BE/MID/General Test Cases/Sign In General Steps'), [('userName') :userName
        ...
        case 3:
            ...
            WebUI.callTestCase(findTestCase('BE/MID/General Test Cases/Sign In General Steps'), [('userName') : 'hjfdknghfdgnnbbvhfdhvnmn'
                    , ('password') : 'hjfdknghfdgnnbbvhfdhvnmn'], FailureHandling.CONTINUE_ON_FAILURE)
