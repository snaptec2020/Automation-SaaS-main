...
CustomKeywords.'mid.framework.menu.openCreditMemosFromSales'()

CustomKeywords.'generalactions.generalActions.waiteSpinnerToHide'()

WebUI.verifyElementPresent(findTestObject('Object Repository/Mid/creditMemos/creditMemoTitle'), 5)
