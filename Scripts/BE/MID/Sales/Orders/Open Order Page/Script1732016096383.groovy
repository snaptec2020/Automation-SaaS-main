...
WebUI.verifyElementPresent(findTestObject('Object Repository/Mid/Orders/orderTitle'), 5)
WebUI.verifyElementPresent(findTestObject('Object Repository/Mid/Orders/ordersList'), 5)
