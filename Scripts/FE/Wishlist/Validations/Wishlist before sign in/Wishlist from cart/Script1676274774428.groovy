...
WebUI.click(findTestObject('Object Repository/WishList/WishList from Cart'))


CustomKeywords.'generalactions.notificationsObject.verifyNotificationVisble'('الرجاء تسجيل الدخول', 'Please login first')
