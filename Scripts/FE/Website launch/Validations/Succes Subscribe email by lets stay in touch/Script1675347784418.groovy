...
WebUI.setText(findTestObject('Headers and Footers/Header contents/Lets stay in touch field'), 'aa@aa.com')

WebUI.click(findTestObject('Headers and Footers/Header contents/Send lets stay in touch Button'))
