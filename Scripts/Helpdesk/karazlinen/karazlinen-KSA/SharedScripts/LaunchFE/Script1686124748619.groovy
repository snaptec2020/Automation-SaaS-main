...
if(WebUI.waitForElementVisible(findTestObject('Object Repository/Helpdesk/karazlinen/karazlinen-KSA/FE/Shared/AllowNotificationPopup'), 3)) {
	//Close the MailChimp ifram
	if(WebUI.waitForElementClickable(findTestObject('Object Repository/Helpdesk/karazlinen/karazlinen-KSA/FE/Shared/AllowNotificationPopupAllow'),2)) {
		WebUI.click(findTestObject('Object Repository/Helpdesk/karazlinen/karazlinen-KSA/FE/Shared/AllowNotificationPopupAllow'))
	}	
}
