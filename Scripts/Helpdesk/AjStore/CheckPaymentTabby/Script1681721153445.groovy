...
//Order with Tabby
WebUI.click(findTestObject('Object Repository/Helpdesk/AjStore/Checkout/PaymentMethod_1_Text'))
...
WebUI.waitForElementClickable(findTestObject('Object Repository/Helpdesk/AjStore/Tabby/OTPFirstDigit_Tabby'), 20)

String url = WebUI.getUrl()

WebUI.verifyMatch(url, 'https://checkout.tabby.ai/.*', true)

WebUI.verifyElementVisible(findTestObject('Object Repository/Helpdesk/AjStore/Tabby/BackToStore'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Helpdesk/AjStore/Tabby/OTPFirstDigit_Tabby'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Helpdesk/AjStore/Tabby/AmountText'))
...
WebUI.waitForElementClickable(findTestObject('Object Repository/Helpdesk/AjStore/Tabby/BackToStore'), 10)

WebUI.click(findTestObject('Object Repository/Helpdesk/AjStore/Tabby/BackToStore'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Helpdesk/AjStore/Tabby/ReturnDialog_Text'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Helpdesk/AjStore/Tabby/ReturnDialog_ReturnToStoreBtn'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Helpdesk/AjStore/Tabby/ReturnDialog_ContinueWithTabbyBtn'))

WebUI.click(findTestObject('Object Repository/Helpdesk/AjStore/Tabby/ReturnDialog_ReturnToStoreBtn'))
