...
WebUI.setText(findTestObject('Object Repository/Helpdesk/AjStore/BE/BEReports/Orders_From'),now.toString())
WebUI.setText(findTestObject('Object Repository/Helpdesk/AjStore/BE/BEReports/Orders_to'),now.toString())
WebUI.click(findTestObject('Object Repository/Helpdesk/AjStore/BE/BEReports/Orders_ShowReports'))

//WebUI.verifyElementVisible(findTestObject('Object Repository/Helpdesk/AjStore/BE/BEReports/Empty_grid'))


WebUI.setText(findTestObject('Object Repository/Helpdesk/AjStore/BE/BEReports/Orders_From'),'1/1/23')
WebUI.setText(findTestObject('Object Repository/Helpdesk/AjStore/BE/BEReports/Orders_to'),'1/1/23')
WebUI.click(findTestObject('Object Repository/Helpdesk/AjStore/BE/BEReports/Orders_ShowReports'))

//long lastHeight=((Number) WebUI.executeJavaScript("return document.body.scrollHeight", null)).longValue();
WebUI.executeJavaScript("window.scrollTo(0, document.body.scrollHeight);", null);

WebUI.waitForElementVisible(findTestObject('Object Repository/Helpdesk/AjStore/BE/BEReports/dataInOrderson01012023'), 10)
WebUI.verifyElementVisible(findTestObject('Object Repository/Helpdesk/AjStore/BE/BEReports/dataInOrderson01012023'))
