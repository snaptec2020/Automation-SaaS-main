...
WebUI.refresh()
if(WebUI.waitForElementPresent(findTestObject('Object Repository/Helpdesk/TheBeautySecrets/KSA/FE/Shared/SubscriptionFrame'), 20)) {
...
if(WebUI.waitForElementPresent(findTestObject('Object Repository/Helpdesk/TheBeautySecrets/KSA/FE/Shared/NotificationFrame'), 20)) {
