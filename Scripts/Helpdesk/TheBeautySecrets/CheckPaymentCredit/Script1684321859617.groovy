...
CustomKeywords.'products.productsFromCatalog.clickJS'(findTestObject('Object Repository/Helpdesk/TheBeautySecrets/FE/Checkout/PaymentMethod_2_Text'),3)

WebUI.waitForElementVisible(findTestObject('Object Repository/Helpdesk/TheBeautySecrets/FE/credit/MainForm'), 10)

WebUI.verifyElementVisible(findTestObject('Object Repository/Helpdesk/TheBeautySecrets/FE/credit/MainForm'))

WebUI.switchToFrame(findTestObject('Object Repository/Helpdesk/TheBeautySecrets/FE/credit/CardNumberInputFrame'), 10)

WebUI.verifyElementVisible(findTestObject('Object Repository/Helpdesk/TheBeautySecrets/FE/credit/CardNumberInput'))

//WebUI.switchToDefaultContent()
//
//WebUI.switchToFrame(findTestObject('Object Repository/Helpdesk/TheBeautySecrets/FE/credit/CardExpiryFrame'), 10)

WebUI.verifyElementVisible(findTestObject('Object Repository/Helpdesk/TheBeautySecrets/FE/credit/CardExpiryInput'))

//WebUI.switchToDefaultContent()
//
//WebUI.switchToFrame(findTestObject('Object Repository/Helpdesk/TheBeautySecrets/FE/credit/CardCVVFrame'), 10)

WebUI.verifyElementVisible(findTestObject('Object Repository/Helpdesk/TheBeautySecrets/FE/credit/CardCVVInput'))

//WebUI.switchToDefaultContent()
//
//WebUI.switchToFrame(findTestObject('Object Repository/Helpdesk/TheBeautySecrets/FE/credit/CardNumberInputFrame'), 10)

WebUI.sendKeys(findTestObject('Object Repository/Helpdesk/TheBeautySecrets/FE/credit/CardNumberInput'), GlobalVariable.MadaCardNum)

//WebUI.switchToDefaultContent()
//
//WebUI.switchToFrame(findTestObject('Object Repository/Helpdesk/TheBeautySecrets/FE/credit/CardExpiryFrame'), 10)

WebUI.sendKeys(findTestObject('Object Repository/Helpdesk/TheBeautySecrets/FE/credit/CardExpiryInput'), GlobalVariable.MadaExpiryDate)

//WebUI.switchToDefaultContent()
//
//WebUI.switchToFrame(findTestObject('Object Repository/Helpdesk/TheBeautySecrets/FE/credit/CardCVVFrame'), 10)

WebUI.sendKeys(findTestObject('Object Repository/Helpdesk/TheBeautySecrets/FE/credit/CardCVVInput'), GlobalVariable.MadaCVV)
...
WebUI.waitForElementPresent(findTestObject('Object Repository/Helpdesk/TheBeautySecrets/FE/credit/MainOTPFrame'), 30)

String url = WebUI.getUrl()

if (!WebUI.verifyMatch(url, 'https://api.checkout.com/.*', true,FailureHandling.OPTIONAL)) {
	CustomKeywords.'products.productsFromCatalog.clickJS'(findTestObject('Object Repository/Helpdesk/TheBeautySecrets/FE/Checkout/FinishPayment'), 2)
	WebUI.waitForPageLoad(10)
	WebUI.delay(20)
	WebUI.waitForElementPresent(findTestObject('Object Repository/Helpdesk/TheBeautySecrets/FE/credit/MainOTPFrame'), 30)
	url = WebUI.getUrl()
...
WebUI.switchToFrame(findTestObject('Object Repository/Helpdesk/TheBeautySecrets/FE/credit/MainOTPFrame'), 10)

WebUI.verifyElementVisible(findTestObject('Object Repository/Helpdesk/TheBeautySecrets/FE/credit/CheckoutOTP'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Helpdesk/TheBeautySecrets/FE/credit/CheckoutConfirm'))

WebUI.sendKeys(findTestObject('Object Repository/Helpdesk/TheBeautySecrets/FE/credit/CheckoutOTP'), '0000')

WebUI.click(findTestObject('Object Repository/Helpdesk/TheBeautySecrets/FE/credit/CheckoutConfirm'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Helpdesk/TheBeautySecrets/FE/credit/WrongOTPErrorText'))

WebUI.click(findTestObject('Object Repository/Helpdesk/TheBeautySecrets/FE/credit/CheckoutCancel'))
//WebUI.delay(3)
...
WebUI.delay(5)
WebUI.waitForPageLoad(10)
WebUI.waitForElementVisible(findTestObject('Object Repository/Helpdesk/TheBeautySecrets/FE/credit/CreditPaymentError'), 20)
WebUI.verifyElementVisible(findTestObject('Object Repository/Helpdesk/TheBeautySecrets/FE/credit/CreditPaymentError'))
