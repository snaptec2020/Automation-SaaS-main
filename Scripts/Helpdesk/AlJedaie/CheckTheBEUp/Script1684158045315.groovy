...
WebUI.verifyElementClickable(findTestObject('Object Repository/Helpdesk/AlJedaie/BE/Menu/Menu_Dashboard'))
WebUI.verifyElementClickable(findTestObject('Object Repository/Helpdesk/AlJedaie/BE/Menu/Menu_Sales'))
WebUI.verifyElementClickable(findTestObject('Object Repository/Helpdesk/AlJedaie/BE/Menu/Menu_Catalog'))
//WebUI.verifyElementClickable(findTestObject('Object Repository/Helpdesk/AlJedaie/BE/Menu/Menu_MobileApp'))

WebUI.click(findTestObject('Object Repository/Helpdesk/AlJedaie/BE/Menu/Menu_Sales'))

WebUI.waitForElementVisible(findTestObject('Object Repository/Helpdesk/AlJedaie/BE/Menu/Menu_Sales_orders'),10)
WebUI.waitForElementClickable(findTestObject('Object Repository/Helpdesk/AlJedaie/BE/Menu/Menu_Sales_orders'),10)
WebUI.click(findTestObject('Object Repository/Helpdesk/AlJedaie/BE/Menu/Menu_Sales_orders'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Helpdesk/AlJedaie/BE/Sales_Order_page/Sales_order_Grid'))
