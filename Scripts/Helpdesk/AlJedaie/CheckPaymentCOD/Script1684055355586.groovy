...
if(WebUI.verifyElementPresent(findTestObject('Object Repository/Helpdesk/AlJedaie/BE/Shared/SomethingWentWrong'), 10,FailureHandling.OPTIONAL) & WebUI.verifyElementPresent(findTestObject('Object Repository/Helpdesk/AlJedaie/BE/Shared/SomethingWentWrongOK'), 10,FailureHandling.OPTIONAL) ) {
	WebUI.click(findTestObject('Object Repository/Helpdesk/AlJedaie/BE/Shared/SomethingWentWrongOK'),FailureHandling.OPTIONAL)
}
...
WebUI.waitForElementClickable(findTestObject('Object Repository/Helpdesk/AlJedaie/BE/Menu/Menu_MageDelight_MobileOTPLogin'),5)
...
WebUI.click(findTestObject('Object Repository/Helpdesk/AlJedaie/FE/Login/ConfirmOTPbtn'))
...
WebUI.verifyElementNotPresent(findTestObject('Object Repository/Helpdesk/AlJedaie/FE/Login/ConfirmOTPbtn'), 2)
WebUI.verifyElementVisible(findTestObject('Object Repository/Helpdesk/AlJedaie/FE/Login/AccountBtn'))

WebUI.click(findTestObject('Object Repository/Helpdesk/AlJedaie/FE/Login/AccountBtn'))

WebUI.waitForElementVisible(findTestObject('Object Repository/Helpdesk/AlJedaie/FE/Login/AccountPopup'),5)
WebUI.verifyElementVisible(findTestObject('Object Repository/Helpdesk/AlJedaie/FE/Login/AccountPopup'))
WebUI.click(findTestObject('Object Repository/Helpdesk/AlJedaie/FE/Login/CloseAccountPopup'))
...
//        removeProductFromCartElements.get(0).click()
		WebUI.waitForElementVisible(findTestObject('Object Repository/Helpdesk/AlJedaie/FE/Cart/ConfirmDelete'),3,FailureHandling.OPTIONAL)
		if(WebUI.verifyElementVisible(findTestObject('Object Repository/Helpdesk/AlJedaie/FE/Cart/ConfirmDelete'),FailureHandling.OPTIONAL)) {
			WebUI.click(findTestObject('Object Repository/Helpdesk/AlJedaie/FE/Cart/ConfirmDelete'))
			WebUI.waitForElementNotVisible(findTestObject('Object Repository/Helpdesk/AlJedaie/FE/Cart/ConfirmDelete'), 3)
		}
...
WebUI.click(findTestObject('Object Repository/Helpdesk/AlJedaie/FE/Cart/OutSideCart'))
//Open Random Product
...
if(WebUI.verifyElementVisible(findTestObject('Object Repository/Helpdesk/AlJedaie/FE/MiniCart/ContinueShoping'), FailureHandling.OPTIONAL)) {
	...
	WebUI.waitForElementClickable(findTestObject('Object Repository/Helpdesk/AlJedaie/FE/MiniCart/ContinueShoping'),5)
	WebUI.click(findTestObject('Object Repository/Helpdesk/AlJedaie/FE/MiniCart/ContinueShoping'))
}else {
...
if (totalValue < 99) {
	...
	for(int increase = 1 ; increase<neededQty ; increase++) {
		WebUI.waitForElementClickable(findTestObject('Object Repository/Helpdesk/AlJedaie/FE/Cart/IncreaseQtyBtn'),5)
		WebUI.click(findTestObject('Object Repository/Helpdesk/AlJedaie/FE/Cart/IncreaseQtyBtn'))
		WebUI.delay(2)
	}
