...
if(WebUI.verifyElementPresent(findTestObject('Object Repository/Helpdesk/AlJedaie/FE/Shared/MailChimpIFrame'), 5, FailureHandling.OPTIONAL)) {
	...
	if(WebUI.waitForElementVisible(findTestObject('Object Repository/Helpdesk/AlJedaie/FE/Shared/MailChimpClose'),20)) {
...
if(WebUI.verifyElementPresent(findTestObject('Object Repository/Helpdesk/AlJedaie/FE/Shared/AllowCookie'), 5, FailureHandling.OPTIONAL)) {
	//Close the MailChimp ifram
	WebUI.waitForElementClickable(findTestObject('Object Repository/Helpdesk/AlJedaie/FE/Shared/AllowCookie'),5)
	WebUI.click(findTestObject('Object Repository/Helpdesk/AlJedaie/FE/Shared/AllowCookie'))
}
