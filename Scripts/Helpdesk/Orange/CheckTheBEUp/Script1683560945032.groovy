...
WebUI.verifyElementClickable(findTestObject('Object Repository/Helpdesk/Orange/BE/Menu/Menu_Dashboard'))
WebUI.verifyElementClickable(findTestObject('Object Repository/Helpdesk/Orange/BE/Menu/Menu_Sales'))
WebUI.verifyElementClickable(findTestObject('Object Repository/Helpdesk/Orange/BE/Menu/Menu_Catalog'))
WebUI.verifyElementClickable(findTestObject('Object Repository/Helpdesk/Orange/BE/Menu/Menu_MobileApp'))
...
WebUI.verifyElementVisible(findTestObject('Object Repository/Helpdesk/Orange/BE/Sales_Order_page/Sales_order_Grid'))
