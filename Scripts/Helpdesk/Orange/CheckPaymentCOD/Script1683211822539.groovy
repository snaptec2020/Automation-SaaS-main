...
WebUI.verifyElementVisible(findTestObject('Object Repository/Helpdesk/Orange/FE/Cart/Add to cart'))
WebUI.click(findTestObject('Object Repository/Helpdesk/Orange/FE/Cart/Add to cart'))
...
WebUI.waitForElementClickable(findTestObject('Object Repository/Helpdesk/Orange/FE/Checkout/ReturnPolicyCheckbox'),10)
WebUI.verifyElementVisible(findTestObject('Object Repository/Helpdesk/Orange/FE/Checkout/ReturnPolicyText'))
WebUI.verifyElementVisible(findTestObject('Object Repository/Helpdesk/Orange/FE/Checkout/ReturnPolicyContentLink'))


WebUI.click(findTestObject('Object Repository/Helpdesk/Orange/FE/Checkout/ReturnPolicyContentLink'))
//int PolicyNewTab = WebUI.getWindowIndex()
//println PolicyNewTab
WebUI.delay(2)
WebUI.switchToWindowIndex(currentTab+2)
WebUI.waitForElementPresent(findTestObject('Object Repository/Helpdesk/Orange/FE/ReturnPolicyPage/Title'),3)
...
WebUI.verifyElementVisible(findTestObject('Object Repository/Helpdesk/Orange/FE/ReturnPolicyPage/Title'))
WebUI.verifyElementVisible(findTestObject('Object Repository/Helpdesk/Orange/FE/ReturnPolicyPage/Paragraph_1'))
WebUI.switchToWindowIndex(currentTab)

WebUI.click(findTestObject('Object Repository/Helpdesk/Orange/FE/Checkout/ReturnPolicyCheckbox'))
...
//WebUI.verifyElementNotVisible(findTestObject('Object Repository/Helpdesk/Orange/FE/Checkout/MapErrorCannotLoad'))
//Steps
WebUI.verifyElementVisible(findTestObject('Object Repository/Helpdesk/Orange/FE/Checkout/Step_4_PaymentMethods'))
...
//Order with COD
WebUI.verifyElementNotPresent(findTestObject('Object Repository/Helpdesk/Orange/FE/Checkout/PaymentMethod_4_Text'),5)
