...
WebUI.setText(findTestObject('Object Repository/Helpdesk/Qasr/BE/Reports/Orders_From'),now.toString())
WebUI.setText(findTestObject('Object Repository/Helpdesk/Qasr/BE/Reports/Orders_to'),now.toString())
WebUI.click(findTestObject('Object Repository/Helpdesk/Qasr/BE/Reports/Orders_ShowReports'))

//WebUI.verifyElementVisible(findTestObject('Object Repository/Helpdesk/Qasr/BE/Reports/Empty_grid'))


WebUI.setText(findTestObject('Object Repository/Helpdesk/Qasr/BE/Reports/Orders_From'),'1/1/23')
WebUI.setText(findTestObject('Object Repository/Helpdesk/Qasr/BE/Reports/Orders_to'),'1/1/23')
WebUI.click(findTestObject('Object Repository/Helpdesk/Qasr/BE/Reports/Orders_ShowReports'))

//long lastHeight=((Number) WebUI.executeJavaScript("return document.body.scrollHeight", null)).longValue();
WebUI.executeJavaScript("window.scrollTo(0, document.body.scrollHeight);", null);

WebUI.waitForElementVisible(findTestObject('Object Repository/Helpdesk/Qasr/BE/Reports/dataInOrderson01012023'), 10)
WebUI.verifyElementVisible(findTestObject('Object Repository/Helpdesk/Qasr/BE/Reports/dataInOrderson01012023'))
